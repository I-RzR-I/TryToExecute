...
//  Last Modified On : 2024-12-03 21:20
// ***********************************************************************
//  <copyright file="TryToExecute.cs" company="RzR SOFT & TECH">
...
namespace TryToExecute.CodeExec
{
    ...
    public abstract partial class TryCatchExecuteBase
    {
        ...
        protected virtual TResult TryToExecute<TResult>(
            ...
            => InternalTryCatchExecHelper.TryIt<TResult, TResult, TResult>(execRequest, onFailureResult, forceCallGarbageCollector);
